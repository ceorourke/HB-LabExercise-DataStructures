...
def sort_by_cohort(filename):
    ...
    for line in student_file:
        ...
        if student[-1] == "G":
            ghosts.append(" ".join(student[:2]))
        elif student[-1] == "Fall 2015":
            fall_15.append(" ".join(student[:2]))
        elif student[-1] == "Summer 2016":
            summer_16.append(" ".join(student[:2]))
        elif student[-1] == "Spring 2016":
            spring_16.append(" ".join(student[:2]))
        elif student[-1] == "Winter 2016":
            winter_16.append(" ".join(student[:2]))
...
def hogwarts_by_house(filename):
    ...
    all_students.extend([gryffindor, hufflepuff, slytherin, dumbledores_army,
                        ghosts, instructors])
